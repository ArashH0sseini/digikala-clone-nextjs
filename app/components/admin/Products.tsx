...
import CreateProductForm from "../shared/form/admin/product/createProductForm";
    ...
    <>
      {"create-product" in router.query && (
        <Modal setShow={() => setShowCreateProduct(false)}>
          <div className="inline-block w-full max-w-3xl  overflow-hidden text-right align-middle transition-all transform bg-white shadow-xl rounded-lg opacity-100 scale-100">
      ...
      <div className="px-4 sm:px-6 lg:px-8 pb-6 mt-5">
        <div className="sm:flex sm:items-center">
          ...
          <div className="mt-4 sm:mt-0 sm:mr-16 sm:flex-none">
            ...
            >
              <a className="inline-flex items-center justify-center rounded-md border border-transparent bg-[#ef4056] px-4 py-2 text-sm font-medium text-white shadow-sm  focus:outline-none focus:ring-2 focus:ring-[#ef4056] focus:ring-offset-2 sm:w-auto">
                اضافه کردن محصول
              </a>
            </Link>
          </div>
